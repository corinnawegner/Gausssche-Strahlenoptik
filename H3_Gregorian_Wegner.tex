...
[Note that this is not a copy error, we indeed measured the same values except for the decimal place]\\
...
$\eta_{single-mode} = \frac{106}{1.2\cdot10^3} = 8.93\% \hspace{1cm} \eta_{single-mode} = \frac{209}{1.2*10^3} = 17.61\%$\\
...
$U_1 = (55\pm1)mV$  voltage with first mirror\\
...
\hline
\multirow{1}{*}{Reflectivity}
        & Total Reflectivity  &$R=  0.9385593220338984 \pm 0.00021226391960195743$\\
        & Reflectivity from $R_{1}$ and $R_{2}$ &$R'=  0.8934340988139043 \pm 1.724414796502769e-06$\\
...
\hline
\multirow{1}{*}{Finesse}
        & Finesse from R & $F= 49.5364337247994$\\
...
$F_{fig} = 3.3 \pm 1.1$\\
This is a very low value compared to the calculated values. As typical finesses are from 10 to up to 100000 \cite{optres} we expect the calculated values to be more accurate. Zooming into the peak of the oscilloscope would have probably improved the resolution of the peak and thus lead to a better reading of the signal.\\
