...
\textcolor{red}{Quellenverzeichnis! https://de.wikipedia.org/wiki/Quantenausbeute}
...
%\begin{listing}
%	\inputminted[bgclolor=LighGray, fontsize=\scriptsize, lineos]{python}{matrizenoptik.py}
%	\caption{Caption}
